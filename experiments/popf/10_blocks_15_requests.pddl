(define (problem pick_place_coordination_problem)
        ...
        (:init
			...
			(reachable blockH box1_pick_loc)
			(reachable blockE box1_drop_loc)
			(reachable blockE box2_pick_loc)
			(reachable blockD box2_drop_loc)
			...
			(reachable blockH box5_drop_loc)
			(reachable blockA box6_pick_loc)
			(reachable blockG box6_drop_loc)
			...
			(reachable blockD box12_drop_loc)

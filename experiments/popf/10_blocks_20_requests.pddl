(define (problem pick_place_coordination_problem)
        ...
        (:init
			...
			(reachable blockG box3_drop_loc)
			(reachable blockH box4_pick_loc)
			(reachable blockD box4_drop_loc)
			(reachable blockF box5_pick_loc)
			(reachable blockD box5_drop_loc)
			(reachable blockE box6_pick_loc)
			(reachable blockC box6_drop_loc)
			(reachable blockE box7_pick_loc)
			(reachable blockD box7_drop_loc)
			(reachable blockB box8_pick_loc)
			(reachable blockE box8_drop_loc)
			(reachable blockE box9_pick_loc)
			(reachable blockB box9_drop_loc)
			(reachable blockE box10_pick_loc)
			(reachable blockC box10_drop_loc)
			(reachable blockF box11_pick_loc)
			(reachable blockE box11_drop_loc)
			(reachable blockA box12_pick_loc)
			(reachable blockG box12_drop_loc)
			(reachable blockD box13_pick_loc)
			(reachable blockB box13_drop_loc)
			(reachable blockG box14_pick_loc)
			(reachable blockC box14_drop_loc)
			(reachable blockG box15_pick_loc)
			(reachable blockF box15_drop_loc)
			(reachable blockA box16_pick_loc)
			(reachable blockE box16_drop_loc)
			(reachable blockD box17_pick_loc)
			(reachable blockA box17_drop_loc)
			(reachable blockC box18_pick_loc)
			(reachable blockD box18_drop_loc)
			(reachable blockD box19_pick_loc)
			(reachable blockA box19_drop_loc)
			(reachable blockH box20_pick_loc)
			(reachable blockE box20_drop_loc)

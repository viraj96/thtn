(in-package :shop-user)
    ...
    (defproblem task pick_place_coordination
        (
			...
			(reachable blockM box15_pick_loc)
			(reachable blockD box15_drop_loc)
			(reachable blockI box16_pick_loc)
			(reachable blockG box16_drop_loc)
			(reachable blockK box17_pick_loc)
			(reachable blockG box17_drop_loc)
			(reachable blockH box18_pick_loc)
			(reachable blockA box18_drop_loc)
			(reachable blockK box19_pick_loc)
			(reachable blockC box19_drop_loc)
			(reachable blockK box20_pick_loc)
			(reachable blockH box20_drop_loc)

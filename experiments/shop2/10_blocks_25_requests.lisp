(in-package :shop-user)
    ...
    (defproblem task pick_place_coordination
        (
			...
			(reachable blockF box2_pick_loc)
			(reachable blockG box2_drop_loc)
			(reachable blockC box3_pick_loc)
			(reachable blockE box3_drop_loc)
			(reachable blockG box4_pick_loc)
			(reachable blockE box4_drop_loc)
			...
			(reachable blockF box8_drop_loc)
			(reachable blockH box9_pick_loc)
			(reachable blockF box9_drop_loc)
			(reachable blockB box10_pick_loc)
			(reachable blockA box10_drop_loc)
			(reachable blockG box11_pick_loc)
			(reachable blockF box11_drop_loc)
			(reachable blockE box12_pick_loc)
			(reachable blockA box12_drop_loc)
			(reachable blockH box13_pick_loc)
			(reachable blockC box13_drop_loc)
			(reachable blockH box14_pick_loc)
			(reachable blockD box14_drop_loc)
			(reachable blockH box15_pick_loc)
			(reachable blockD box15_drop_loc)
			(reachable blockG box16_pick_loc)
			(reachable blockF box16_drop_loc)
			(reachable blockF box17_pick_loc)
			(reachable blockB box17_drop_loc)
			(reachable blockC box18_pick_loc)
			(reachable blockD box18_drop_loc)
			(reachable blockA box19_pick_loc)
			(reachable blockB box19_drop_loc)
			(reachable blockC box20_pick_loc)
			(reachable blockG box20_drop_loc)
			(reachable blockG box21_pick_loc)
			(reachable blockH box21_drop_loc)
			(reachable blockH box22_pick_loc)
			(reachable blockF box22_drop_loc)
			(reachable blockF box23_pick_loc)
			(reachable blockD box23_drop_loc)
			(reachable blockG box24_pick_loc)
			(reachable blockB box24_drop_loc)
			(reachable blockB box25_pick_loc)
			(reachable blockH box25_drop_loc)

(in-package :shop-user)
    ...
    (defproblem task pick_place_coordination
        (
			...
			(reachable blockL box3_pick_loc)
			...
			(reachable blockJ box6_drop_loc)
			(reachable blockF box7_pick_loc)
			(reachable blockE box7_drop_loc)
			(reachable blockM box8_pick_loc)
			(reachable blockD box8_drop_loc)
			(reachable blockC box9_pick_loc)
			(reachable blockD box9_drop_loc)
			(reachable blockG box10_pick_loc)

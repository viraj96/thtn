(in-package :shop-user)
    ...
    (defproblem task pick_place_coordination
        (
			...
			(reachable blockA box5_drop_loc)
			(reachable blockA box6_pick_loc)
			(reachable blockB box6_drop_loc)
			...
			(reachable blockC box10_pick_loc)
			...
			(reachable blockA box14_pick_loc)
			(reachable blockB box14_drop_loc)

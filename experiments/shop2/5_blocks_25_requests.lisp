(in-package :shop-user)
    ...
    (defproblem task pick_place_coordination
        (
			...
			(reachable blockB box7_drop_loc)
			...
			(reachable blockB box10_drop_loc)
			(reachable blockB box11_pick_loc)
			(reachable blockC box11_drop_loc)
			(reachable blockA box12_pick_loc)
			(reachable blockB box12_drop_loc)
			(reachable blockB box13_pick_loc)
			(reachable blockA box13_drop_loc)
			(reachable blockB box14_pick_loc)
			(reachable blockC box14_drop_loc)
			(reachable blockC box15_pick_loc)
			(reachable blockB box15_drop_loc)
			(reachable blockA box16_pick_loc)
			(reachable blockB box16_drop_loc)
			(reachable blockA box17_pick_loc)
			(reachable blockB box17_drop_loc)
			(reachable blockA box18_pick_loc)
			(reachable blockC box18_drop_loc)
			(reachable blockA box19_pick_loc)
			(reachable blockB box19_drop_loc)
			(reachable blockC box20_pick_loc)
			(reachable blockB box20_drop_loc)
			(reachable blockA box21_pick_loc)
			(reachable blockB box21_drop_loc)
			(reachable blockB box22_pick_loc)
			(reachable blockA box22_drop_loc)
			(reachable blockC box23_pick_loc)
			(reachable blockA box23_drop_loc)
			(reachable blockA box24_pick_loc)
			(reachable blockC box24_drop_loc)
			(reachable blockA box25_pick_loc)
			(reachable blockB box25_drop_loc)
